...
class Character(models.Model):
    ...
    fp = models.IntegerField(blank=True)
    san = models.IntegerField(blank=True)
    mab = models.IntegerField(blank=True)
    rab = models.IntegerField(blank=True)
    ac = models.IntegerField(blank=True)
    will = models.IntegerField(blank=True)
    re = models.DecimalField(decimal_places=2, max_digits=10)
    fort = models.IntegerField(blank=True)
    per = models.IntegerField(blank=True)
    mo = models.IntegerField(blank=True)
